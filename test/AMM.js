...
describe('AMM', () => {
  let accounts, deployer, token1, token2, amm, liquidityProvider
  ...
  describe('Swapping Tokens', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      /////////////////////////////////////////////////////////
      // Liquidity provider adds more liquidity
      //

      // Liquidity provider approves 50k tokens
      amount = tokens(50000)
      ...
      // Liquidity provider should have 50 shares
